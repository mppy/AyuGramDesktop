...
class PurrLanguage : public QObject
{
	Q_OBJECT
	Q_DISABLE_COPY(PurrLanguage)

public:
	static PurrLanguage *currentInstance();
	static void init();
	static PurrLanguage *instance;
