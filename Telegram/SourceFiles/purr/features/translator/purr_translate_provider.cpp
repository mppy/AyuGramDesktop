...
#include "purr/features/translator/purr_translate_provider.h"

#include "api/api_text_entities.h"
#include "purr/features/translator/purr_translator.h"
...
class PurrTranslateProvider final : public Ui::TranslateProvider {
public:
	PurrTranslateProvider(
		not_null<Main::Session*> session,
		TranslationProvider provider)
	: _session(session)
	, _provider(provider) {
		if (!Purr::Translator::TranslateManager::currentInstance()) {
	...
	void requestBatch(
		...
		const auto manager = Purr::Translator::TranslateManager::currentInstance();
...
std::unique_ptr<TranslateProvider> CreatePurrTranslateProvider(
		not_null<Main::Session*> session,
		TranslationProvider provider) {
	return std::make_unique<PurrTranslateProvider>(session, provider);
}
