...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"PurrGram.PurrGramDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"PurrGram.PurrGramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"PurrGram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"PurrGram Desktop/PurrGram.lnk"_q;
	const auto old = u"PurrGram for Windows/PurrGram.lnk"_q;
